...
5. **Generalist** — Coding ist eine starke Capability, nicht der Zweck
6. **Selbstverbessernd** — je länger genutzt, desto besser (Skills, Memory)

## Abgrenzung

- **vs. Claude Code / Codex:** eaccode vergisst nicht — Memory über Sessions,
  Session-Suche, Skill-Schatz
- **vs. Hermes:** eigene Codebasis, eigene Identität, Coding auf Claude-Code-Niveau
- **vs. SaaS:** keine Abos, Keys gehören dir, Daten bleiben lokal

## Zielbild

> „Öffne morgen früh einen PR für Issue #42 in Repo X" — eaccode erinnert sich
